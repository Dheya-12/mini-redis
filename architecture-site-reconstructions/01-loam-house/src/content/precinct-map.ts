...
export const AMENITIES: Amenity[] = [
  {
    ...
    x: 903.6,
    y: 596.0,
    blurb: "Curated native gardens that shift with the seasons, threaded through the precinct.",
  },
  {
    id: "02",
    name: "Fire Pits",
    ...
    x: 896.9,
    y: 511.6,
    blurb: "Gather close as the evening cools — open flame beneath open sky.",
  },
  {
    id: "03",
    name: "Barbeques",
    ...
    x: 884.0,
    y: 681.6,
    blurb: "Alfresco kitchens made for long lunches and easy entertaining.",
  },
  {
    id: "04",
    name: "Resident Dining Room",
    category: "social",
    x: 866.7,
    y: 715.1,
    blurb: "A private dining room for the dinners too large for your own table.",
  },
  {
    id: "05",
    name: "Terrace",
    ...
    x: 857.2,
    y: 681.5,
    blurb: "An elevated outdoor room for morning coffee and golden-hour drinks.",
  },
  {
    id: "06",
    name: "Wine Room",
    ...
    x: 841.0,
    y: 715.1,
    blurb: "Temperature-controlled cellaring and a table made for tasting.",
  },
  {
    id: "07",
    name: "Movie Room",
    ...
    x: 872.2,
    y: 748.4,
    blurb: "Plush, dim and yours to book — cinema without leaving home.",
  },
  {
    id: "08",
    name: "Work Space",
    ...
    x: 820.8,
    y: 701.1,
    blurb: "Quiet desks and meeting nooks for the days you work from here.",
  },
  {
    id: "09",
    name: "The Retreat",
    ...
    x: 965.1,
    y: 505.0,
    blurb: "A calm sanctuary to slow down, stretch out and reset.",
  },
  {
    id: "10",
    name: "Car and Dog Wash",
    category: "services",
    x: 748.1,
    y: 673.6,
    blurb: "A bay for the car and a bath for the dog — the practical made effortless.",
  },
  {
    id: "11",
    ...
    x: 758.7,
    y: 264.9,
    blurb: "A fully-equipped gym downstairs, open whenever you are.",
  },
  {
    id: "12",
    name: "Golf Simulator",
    ...
    x: 767.2,
    y: 294.0,
    blurb: "Play St Andrews before breakfast on a full-swing simulator.",
  },
  {
    id: "13",
    ...
    x: 809.7,
    y: 267.7,
    blurb: "A boardroom and private offices for when work gets serious.",
  },
];
