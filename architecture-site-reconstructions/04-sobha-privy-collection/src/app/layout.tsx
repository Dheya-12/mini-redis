...
/**
 * Runs before first paint: the same root classes the original sets from its <head>, and the route name that scopes
 * each route's stylesheet (see tools/extract-styles.mjs).
 */
const BOOT = `(function(){var d=document.documentElement;d.classList.remove('no-js');d.classList.add('js');
